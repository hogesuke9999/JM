...
<?php
	...
	print "<form method=\"POST\" action=\"showjoblist2.php\">\n";
...
#					$pre_job_description = $row[3];
		...
		print "<table border=1>";
		print "<tr><th>job_id</th><th>job_datetime1</th><th>job_datetime2</th><th>job_datetime3</th><th>user_id</th><th>job_description</th></tr>";
		...
		for ($i = 0; $i < pg_num_rows($result); $i++) {
			...
			if( $pre_job_id === "" ) {
				...
				print "<td>" . $pre_job_datetime              . "</td>";
				print "<td>" . $row[1]                        . "</td>";
				print "<td>" . ( strtotime($row[1]) - strtotime($pre_job_datetime) ) . "</td>";
				print "<td>" . $pre_user_id                   . "</td>";
				print "<td>" . $pre_job_description           . "</td>";
				print "</tr>";
		...
		print "<table border=1>";
		print "<tr><th>job_description</th><th>job_datetime</th><th></th></tr>";
